...
Peter Corke \cite{corke_robotics_toolbox}, códigos \ref{lst:dh} y \ref{lst:dh_salida}.
...
Podemos calcular y comprobar el resultado en \textit{Matlab} \cite{matlabonline2025} y la \textit{toolbox} de
Peter Corke \cite{corke_robotics_toolbox}, códigos \ref{lst:dh_mod} y \ref{lst:dh_mod_salida}. 
En la figura \ref{fig:dh} se presenta el modelado del robot en \textit{Matlab}. \\

\begin{figure}[htb]
    \centering
    \includegraphics[scale=1.5]{Images/cinematica/modelado2.png}
...
\textit{toolbox} de Peter Corke \cite{corke_robotics_toolbox} mediante el código 
\ref{lst:ik}. \\
...
\subsubsection{Cálculo de cinemática inversa para el \textit{UFactory xArm6}}
...
En los códigos \ref{lst:ik_nr} y \ref{lst:ik_nr_salida} se expone la porción de código de \textit{Matlab} \cite{matlabonline2025} y la \textit{Robotics Toolbox} de
...
\subsubsection{Trayectorias lineales en espacio cartesiano} 
...
\subsubsection{Trayectorias circulares en espacio cartesiano}
...
\subsubsection{Trayectorias polinómicas en espacio articular}
...
\subsubsection{Trayectorias \textit{spline} (\textit{multi-waypoint})}
...
Las imágenes \ref{fig:traj} y \ref{fig:traj_2} muestran la trayectoria calculada mediante el código 
